...
[^1]: We are just looking at the calculated performance columns for Indicators 1a and 1d and their 95% confidence intervals. By default, the `seqic_indicator_*()` functions will also give the numerator and denominator.
...
-   `nemsqar`[^2]: First statewide report on all 21 NEMSQA measures in Iowa
    -   Project and examples: https://github.com/bemts-hhs/NEMSQA-Report-2025
-   Reproducible, interpretable, fast

[^2]: Similar trauma/EMS bureaus in Oregon and Connecticut are using `nemsqar`, along with the quality managers at Dallas Fire and Washington D.C. Fire
